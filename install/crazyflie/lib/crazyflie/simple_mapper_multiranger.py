...
class SimpleMapperMultiranger(Node):
    def __init__(self):
        ...
        # initial_position = self.get_parameter('initial_position').value
        # t_map.transform.translation.x = initial_position[0]
        # t_map.transform.translation.y = initial_position[1]
        # t_map.transform.translation.z = initial_position[2]
    ...
    def scan_subscribe_callback(self, msg):
        ...
        # self.declare_parameter('initial_position', [0.0, 0.0, 0.0])
        # initial_position = self.get_parameter('initial_position').value
        # msg.info.origin.position.x = initial_position[0] - GLOBAL_SIZE_X / 2.0
        # msg.info.origin.position.y = initial_position[1] - GLOBAL_SIZE_Y / 2.0
